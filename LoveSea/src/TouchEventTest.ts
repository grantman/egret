...
class TouchEventTest extends egret.DisplayObjectContainer
{
    ...
    private onAddToStage(event:egret.Event)
    {
        ...
        this.addEventListener(egret.TouchEvent.TOUCH_TAP,this.onTouchTaps,this);
    }
    ...
    private onTouchTaps(event:egret.TouchEvent)
    {
        this.txt.text += "\内容捕获侦听";
    }
    //绘制文本
